...
e++;}else{if(a(this).attr("id")==undefined){a(this).attr("id","single_visor_"+b);b++;}}a(this).click(function(){function j(C,t,B,A,v,w){function z(){a("body").css("overflow","visible");
